...
let project = "HttpFs.Auth0"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Support for authentication patterns using Auth0"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Provides constructs which make it easier to use Auth0 when interacting with protected APIs."

// List of author names (for NuGet package)
let authors = [ "Marcus Griep <marcus@griep.us>" ]

// Tags for your project (for NuGet package)
let tags = "http auth0 authentication"

// File system information
let solutionFile  = "HttpFs.Auth0.sln"
...
Target "InternalizeFileRefs" <| fun _ ->
    ReplaceInFiles
        [ "module internal YoLo", "module internal HttpFs.Auth0.YoLo" ]
        [ "paket-files/neoeinstein/YoLo/YoLo.fs" ]

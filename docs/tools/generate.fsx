...
let website = "/HttpFs.Auth0"

let githubLink = "https://github.com/neoeinstein/HttpFs.Auth0"

// Specify more information about your project
let info =
  [ "project-name", "HttpFs.Auth0"
    "project-author", "Marcus Griep <marcus@griep.us>"
    "project-summary", "Support for authentication patterns using Auth0"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/HttpFs.Auth0" ]
